...
// //             <div className="bg-white rounded-3xl shadow-md hover:shadow-2xl transition-all duration-300 p-7 h-full">

// //               <FaQuoteLeft className="text-purple-600 text-3xl mb-5" />

// //               <p className="text-gray-600 leading-7 min-h-[120px]">
// //                 {item.review}
// //               </p>
